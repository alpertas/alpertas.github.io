...
export const projectsData = [
  {
    ...
    description:
      'React Native e-commerce app with payment integration and real-time notifications.',
  ...
  },
  {
    ...
    description:
      'Modern web dashboard for project management with real-time collaboration features.',
  ...
  },
  {
    ...
    tags: ['React Native', 'API Integration', 'Maps', 'Animations'],
    demoUrl: '#',
    codeUrl: '#',
    featured: true,
  },
